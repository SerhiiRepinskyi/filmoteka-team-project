 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}));yo.logoutBtn.addEventListener("click",(async()=>{var e;await(e=vo,Re(e).signOut())}));const xo=()=>{yo.loginForm.classList.toggle("login-hidden"),yo.registerForm.classList.toggle("register-hidden")};yo.showLoginBtn.addEventListener("click",xo),yo.showRegisterBtn.addEventListener("click",xo);const wo=()=>{yo.modal.classList.toggle("auth-modal-is-hidden")};yo.openModalBtn.addEventListener("click",wo),yo.closeModalBtn.addEventListener("click",wo);var ko={},_o=/^\s+|\s+$/g,Io=/^[-+]0x[0-9a-f]+$/i,No=/^0b[01]+$/i,Co=/^0o[0-7]+$/i,To=parseInt,So="object"==typeof t&&t&&t.Object===Object&&t,Eo="object"==typeof self&&self&&self.Object===Object&&self,Lo=So||Eo||Function("return this")(),Ao=Object.prototype.toString,Ro=Math.max,Mo=Math.min,Oo=function(){return Lo.Date.now()};function Po(e,t,n){var i,o,a,r,s,l,c=0,u=!1,d=!1,f=!0;if("function"!=typeof e)throw new TypeError("Expected a function");function m(t){var n=i,a=o;return i=o=void 0,c=t,r=e.apply(a,n)}function p(e){return c=e,s=setTimeout(g,t),u?m(e):r}function h(e){var n=e-l;return void 0===l||n>=t||n<0||d&&e-c>=a}function g(){var e=Oo();if(h(e))return b(e);s=setTimeout(g,function(e){var n=t-(e-l);return d?Mo(n,a-(e-c)):n}(e))}function b(e){return s=void 0,f&&i?m(e):(i=o=void 0,r)}function y(){var e=Oo(),n=h(e);if(i=arguments,o=this,l=e,n){if(void 0===s)return p(l);if(d)return s=setTimeout(g,t),m(l)}return void 0===s&&(s=setTimeout(g,t)),r}return t=zo(t)||0,Do(n)&&(u=!!n.leading,a=(d="maxWait"in n)?Ro(zo(n.maxWait)||0,t):a,f="trailing"in n?!!n.trailing:f),y.cancel=function(){void 0!==s&&clearTimeout(s),c=0,i=l=o=s=void 0},y.flush=function(){return void 0===s?r:b(Oo())},y}function Do(e){var t=typeof e;return!!e&&("object"==t||"function"==t)}function zo(e){if("number"==typeof e)return e;if(function(e){return"symbol"==typeof e||function(e){return!!e&&"object"==typeof e}(e)&&"[object Symbol]"==Ao.call(e)}(e))return NaN;if(Do(e)){var t="function"==typeof e.valueOf?e.valueOf():e;e=Do(t)?t+"":t}if("string"!=typeof e)return 0===e?e:+e;e=e.replace(_o,"");var n=No.test(e);return n||Co.test(e)?To(e.slice(2),n?2:8):Io.test(e)?NaN:+e}ko=function(e,t,n){var i=!0,o=!0;if("function"!=typeof e)throw new TypeError("Expected a function");return Do(n)&&(i="leading"in n?!!n.leading:i,o="trailing"in n?!!n.trailing:o),Po(e,t,{leading:i,maxWait:t,trailing:o})},window.addEventListener("scroll",ko((function(){console.log("scroll scroll");const e=document.querySelector(".scroll-to-top");document.body.scrollTop>550||document.documentElement.scrollTop>550?e.style.display="flex":e.style.display="none"}),1e3));
//# sourceMappingURL=index.42d71edb.js.map
