 ...
 * limitations under the License.
 */
function Pe(e){const t=[];for(const[n,i]of Object.entries(e))Array.isArray(i)?i.forEach((e=>{t.push(encodeURIComponent(n)+"="+encodeURIComponent(e))})):t.push(encodeURIComponent(n)+"="+encodeURIComponent(i));return t.length?"&"+t.join("&"):""}function Me(e){const t={};return e.replace(/^\?/,"").split("&").forEach((e=>{if(e){const[n,i]=e.split("=");t[decodeURIComponent(n)]=decodeURIComponent(i)}})),t}function Oe(e){const t=e.indexOf("?");if(!t)return"";const n=e.indexOf("#",t);return e.substring(t,n>0?n:void 0)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ot{async triggerHeartbeat(){const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),t=Dt();if(null===this._heartbeatsCache&&(this._heartbeatsCache=await this._heartbeatsCachePromise),this._heartbeatsCache.lastSentHeartbeatDate!==t&&!this._heartbeatsCache.heartbeats.some((e=>e.date===t)))return this._heartbeatsCache.heartbeats.push({date:t,agent:e}),this._heartbeatsCache.heartbeats=this._heartbeatsCache.heartbeats.filter((e=>{const t=new Date(e.date).valueOf();return Date.now()-t<=2592e6})),this._storage.overwrite(this._heartbeatsCache)}async getHeartbeatsHeader(){if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null===this._heartbeatsCache||0===this._heartbeatsCache.heartbeats.length)return"";const e=Dt(),{heartbeatsToSend:t,unsentEntries:n}=function(e,t=1024){const n=[];let i=e.slice();for(const o of e){const e=n.find((e=>e.agent===o.agent));if(e){if(e.dates.push(o.date),Ft(n)>t){e.dates.pop();break}}else if(n.push({agent:o.agent,dates:[o.date]}),Ft(n)>t){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}(this._heartbeatsCache.heartbeats),i=te(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new zt(t),this._heartbeatsCachePromise=this._storage.read().then((e=>(this._heartbeatsCache=e,e)))}}function Dt(){return(new Date).toISOString().substring(0,10)}class zt{async runIndexedDBEnvironmentCheck(){return!!ve()&&new Promise(((e,t)=>{try{let n=!0;const i="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(i);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(i),e(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{var e;t((null===(e=o.error)||void 0===e?void 0:e.message)||"")}}catch(e){t(e)}})).then((()=>!0)).catch((()=>!1))}async read(){if(await this._canUseIndexedDBPromise){return await async function(e){try{return(await At()).transaction("firebase-heartbeat-store").objectStore("firebase-heartbeat-store").get(Mt(e))}catch(e){if(e instanceof _e)_t.warn(e.message);else{const t=Nt.create("idb-get",{originalErrorMessage:null==e?void 0:e.message});_t.warn(t.message)}}}(this.app)||{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Pt(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){var t;if(await this._canUseIndexedDBPromise){const n=await this.read();return Pt(this.app,{lastSentHeartbeatDate:null!==(t=e.lastSentHeartbeatDate)&&void 0!==t?t:n.lastSentHeartbeatDate,heartbeats:[...n.heartbeats,...e.heartbeats]})}}constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}}function Ft(e){return te(JSON.stringify({version:2,heartbeats:e})).length}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function An(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Dn(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(Pn(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Fn(t))return"Blackberry";if(Wn(t))return"Webos";if(Mn(t))return"Safari";if((t.includes("chrome/")||On(t))&&!t.includes("edge/"))return"Chrome";if(zn(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function Pn(e=de()){return/firefox\//i.test(e)}function Mn(e=de()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function On(e=de()){return/crios\//i.test(e)}function Dn(e=de()){return/iemobile/i.test(e)}function zn(e=de()){return/android/i.test(e)}function Fn(e=de()){return/blackberry/i.test(e)}function Wn(e=de()){return/webos/i.test(e)}function Un(e=de()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Bn(){return ge()&&10===document.documentMode}function jn(e=de()){return Un(e)||zn(e)||Wn(e)||Fn(e)||/windows phone/i.test(e)||Dn(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class oi{static parseLink(e){const t=function(e){const t=Me(Oe(e)).link,n=t?Me(Oe(t)).deep_link_id:null,i=Me(Oe(e)).deep_link_id;return(i?Me(Oe(i)).link:null)||i||n||t||e}(e);try{return new oi(t)}catch(e){return null}}constructor(e){var t,n,i,o,r,s;const a=Me(Oe(e)),l=null!==(t=a.apiKey)&&void 0!==t?t:null,c=null!==(n=a.oobCode)&&void 0!==n?n:null,u=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(i=a.mode)&&void 0!==i?i:null);Yt(l&&c&&u,"argument-error"),this.apiKey=l,this.operation=u,this.code=c,this.continueUrl=null!==(o=a.continueUrl)&&void 0!==o?o:null,this.languageCode=null!==(r=a.languageCode)&&void 0!==r?r:null,this.tenantId=null!==(s=a.tenantId)&&void 0!==s?s:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var As,Ps;function Ms(e){return{fromUser:!1,fromServer:!0,queryId:e,tagged:!0}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Ps=As||(As={}))[Ps.OVERWRITE=0]="OVERWRITE",Ps[Ps.MERGE=1]="MERGE",Ps[Ps.ACK_USER_WRITE=2]="ACK_USER_WRITE",Ps[Ps.LISTEN_COMPLETE=3]="LISTEN_COMPLETE";class Os{operationForChild(e){if(Pr(this.path)){if(null!=this.affectedTree.value)return G(this.affectedTree.children.isEmpty(),"affectedTree should not have overlapping affected paths."),this;{const t=this.affectedTree.subtree(new Cr(e));return new Os(Ir(),t,this.revert)}}return G(Nr(this.path)===e,"operationForChild called for unrelated child."),new Os(Sr(this.path),this.affectedTree,this.revert)}constructor(e,t,n){this.path=e,this.affectedTree=t,this.revert=n,this.type=As.ACK_USER_WRITE,this.source={fromUser:!0,fromServer:!1,queryId:null,tagged:!1}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class Ds{operationForChild(e){return Pr(this.path)?new Ds(this.source,Ir(),this.snap.getImmediateChild(e)):new Ds(this.source,Sr(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=As.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zs{operationForChild(e){if(Pr(this.path)){const t=this.children.subtree(new Cr(e));return t.isEmpty()?null:t.value?new Ds(this.source,Ir(),t.value):new zs(this.source,Ir(),t)}return G(Nr(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new zs(this.source,Sr(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=As.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let La,Aa;function Pa(e,t,n,i){const o=t.source.queryId;if(null!==o){const r=e.views.get(o);return G(null!=r,"SyncTree gave us an op for an invalid query."),Ea(r,t,n,i)}{let o=[];for(const r of e.views.values())o=o.concat(Ea(r,t,n,i));return o}}function Ma(e,t){let n=null;for(const i of e.views.values())n=n||Sa(i,t);return n}class Oa{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Xs(null),this.pendingWriteTree_={visibleWrites:$s.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Da(e,t,n,i,o){return function(e,t,n,i,o){G(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===o&&(o=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:o}),o&&(e.visibleWrites=Ks(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,o),o?Ba(e,new Ds({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function za(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(ra(e.pendingWriteTree_,t)){let t=new Xs(null);return null!=i.snap?t=t.set(Ir(),!0):Qo(i.children,(e=>{t=t.set(new Cr(e),!0)})),Ba(e,new Os(i.path,t,n))}return[]}function Fa(e,t,n){return Ba(e,new Ds({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Wa(e,t,n,i){const o=Ha(e,i);if(null!=o){const i=Va(o),r=i.path,s=i.queryId,a=Mr(r,t);return Xa(e,r,new Ds(Ms(s),a,n))}return[]}function Ua(e,t,n){const i=e.pendingWriteTree_,o=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=Ma(n,Mr(e,t));if(i)return i}));return ca(i,t,o,n,!0)}function Ba(e,t){return ja(t,e.syncPointTree_,null,oa(e.pendingWriteTree_,Ir()))}function ja(e,t,n,i){if(Pr(e.path))return qa(e,t,n,i);{const o=t.get(Ir());null==n&&null!=o&&(n=Ma(o,Ir()));let r=[];const s=Nr(e.path),a=e.operationForChild(s),l=t.children.get(s);if(l&&a){const e=n?n.getImmediateChild(s):null,t=ga(i,s);r=r.concat(ja(a,l,e,t))}return o&&(r=r.concat(Pa(o,e,i,n))),r}}function qa(e,t,n,i){const o=t.get(Ir());null==n&&null!=o&&(n=Ma(o,Ir()));let r=[];return t.children.inorderTraversal(((t,o)=>{const s=n?n.getImmediateChild(t):null,a=ga(i,t),l=e.operationForChild(t);l&&(r=r.concat(qa(l,o,s,a)))})),o&&(r=r.concat(Pa(o,e,i,n))),r}function Ha(e,t){return e.tagToQueryMap.get(t)}function Va(e){const t=e.indexOf("$");return G(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new Cr(e.substr(0,t))}}function Xa(e,t,n){const i=e.syncPointTree_.get(t);G(i,"Missing sync point for query tag that we're tracking");return Pa(i,n,oa(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class gl{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function yl(e,t){let n=null;for(let i=0;i<t.length;i++){const o=t[i],r=o.getPath();null===n||Or(r,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:r}),n.events.push(o)}n&&e.eventLists_.push(n)}function vl(e,t,n){yl(e,n),_l(e,(e=>Dr(e,t)||Dr(t,e)))}function _l(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const o=e.eventLists_[i];if(o){t(o.path)?(bl(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function bl(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();Fo&&Bo("event: "+n.toString()),nr(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
